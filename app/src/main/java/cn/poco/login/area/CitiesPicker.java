...
import cn.poco.login.area.AreaList.AreaInfo;
...
//			list.getDivider().setBounds(ShareData.PxToDpi_xhdpi(30),);
//			list.setDivider(new ColorDrawable(0x33333333));
...
//		m_curIndex ++;
	...
	public class ListAdapter extends BaseAdapter
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
			if(convertView == null)
			{
				AbsListView.LayoutParams al = new AbsListView.LayoutParams(AbsListView.LayoutParams.MATCH_PARENT, ShareData.PxToDpi_xhdpi(90));
				convertView = new ChooseItem(getContext());
				convertView.setLayoutParams(al);
				((ChooseItem)convertView).isShowLine(true);
			}
