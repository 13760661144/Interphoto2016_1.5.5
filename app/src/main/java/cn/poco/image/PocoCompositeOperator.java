...
public class PocoCompositeOperator
{
	...
	public static final int NoCompositeOp = 1; //图层模式:无
	...
	public static final int ColorBurnCompositeOp = 8; //颜色加深
	public static final int ColorDodgeCompositeOp = 9; //颜色减淡
	...
	public static final int DarkenCompositeOp = 20; //变暗
	...
	public static final int DifferenceCompositeOp = 26; //差值
	public static final int DisplaceCompositeOp = 27;
	public static final int DissolveCompositeOp = 28;
	public static final int ExclusionCompositeOp = 29; //排除
	public static final int HardLightCompositeOp = 30; //强光
	public static final int HueCompositeOp = 31;
	public static final int InCompositeOp = 32;
	public static final int LightenCompositeOp = 33; //变亮
	public static final int LinearLightCompositeOp = 34; //线性光
	...
	public static final int MultiplyCompositeOp = 38; //正片叠底
	public static final int OutCompositeOp = 39;
	public static final int OverCompositeOp = 40;
	public static final int OverlayCompositeOp = 41; //叠加
	...
	public static final int ScreenCompositeOp = 45; //滤色
	public static final int SoftLightCompositeOp = 46; //柔光
	...
	public static final int VividLightCompositeOp = 59; //亮光
	public static final int PinLightCompositeOp = 60;
	public static final int LinearDodgeCompositeOp = 61; //线性减淡
	public static final int LinearBurnCompositeOp = 62; //线性加深
