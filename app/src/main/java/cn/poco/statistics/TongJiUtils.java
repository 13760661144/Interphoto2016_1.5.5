...
public class TongJiUtils
{
	...
	public static void onPageResume(Context context, String tag) {
		TongJi2.OnResume(context, tag);
	}
	...
	public static void onPagePause(Context context, String tag) {
		TongJi2.OnPause(context, tag);
	}
}
