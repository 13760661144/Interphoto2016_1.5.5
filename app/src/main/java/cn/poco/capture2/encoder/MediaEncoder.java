package cn.poco.capture2.encoder;
...
public abstract class MediaEncoder implements Runnable {
    ...
    /**
     * true:VideoEncoder, false:AudioEncoder
     */
    protected boolean mEncoderType;
...
//		android.os.Process.setThreadPriority(android.os.Process.THREAD_PRIORITY_URGENT_AUDIO);
        ...
        while (!isRelease && !Thread.currentThread().isInterrupted()) {
            synchronized (mSync) {
...
//                        e.printStackTrace();
   ...
   /*package*/
    ...
    public void setViewSize(float width, float height) {
        if (DEBUG) Log.i(TAG, "setSurfaceSize:"+width+", "+height);
    }
    ...
    public void resumeRecording() {
        if (DEBUG) Log.d(TAG, "resumeRecording");
        synchronized (mSync) {
...
//                final ByteBuffer encodedData = mMediaCodec.getOutputBuffer(encoderStatus);
                ...
                if (mBufferInfo.size != 0) {
                    ...
                    mBufferInfo.presentationTimeUs = getPTSUs();
                      ...
                      // timestampUs 391333 < lastTimestampUs 391378 for Audio track error
//                    mBufferInfo.presentationTimeUs = muxer.getPresentationTimeUs(mEncoderType, getPTSUs());
