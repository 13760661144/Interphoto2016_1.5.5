...
public class MediaVideoEncoder extends MediaEncoder implements IFrameRenderer {
    ...
    public MediaVideoEncoder(final MediaMuxerWrapper muxer, final MediaEncoderListener listener,
							 final int width, final int height, OnInitListener onInitListener) {
...
//            codecName = list.findEncoderForFormat(format);
//        }
...
//        }
        ...
        MediaCodecInfo info = EncodeUtils.selectCodec(MIME_TYPE, mColorFormat);
        if (info != null) {
