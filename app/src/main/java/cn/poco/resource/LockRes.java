...
public class LockRes extends BaseRes
{
	...
	public Object m_shareImg1;

	public String url_showImg;
	public String url_shareImg;
	public String url_shareImg1;
	...
	public void OnBuildPath(DownloadItem item)
	{
		if(item != null)
		{
			...
			if(!item.m_onlyThumb)
			{
				...
				name = DownloadMgr.GetImgFileName(url_shareImg1);
				if(name != null && !name.equals(""))
				{
					item.m_paths[2] = parentPath + File.separator + name;
					item.m_urls[2] = url_shareImg1;
				}
			}
		}
	}
