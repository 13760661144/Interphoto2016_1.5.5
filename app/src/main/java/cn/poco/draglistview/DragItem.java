...
public class DragItem {
    ...
    protected float mPosTouchDx;
    protected float mPosTouchDy;
    protected float mAnimationDx;
    protected float mAnimationDy;
    protected boolean mCanDragHorizontally = true;
    protected boolean mSnapToTouch = true;
    ...
    public DragItem(Context context, View view) {
        mDragView = view;
        hide();
    }
    ...
    protected void setCanDragHorizontally(boolean canDragHorizontally) {
    ...
    protected void endDrag(View parent, View endToView, AnimatorListenerAdapter listener) {
        ...
        float endX = parentX + endToView.getX() - (mDragView.getMeasuredWidth() - endToView.getMeasuredWidth()) / 2 + mDragView
                .getMeasuredWidth() / 2;
        float endY = parentY + endToView.getY() - (mDragView.getMeasuredHeight() - endToView.getMeasuredHeight()) / 2 + mDragView
                .getMeasuredHeight() / 2;
    ...
    protected void setAnimationDx(float x) {
        mAnimationDx = x;
        updatePosition();
    }

    protected void setAnimationDY(float y) {
        mAnimationDy = y;
        updatePosition();
    }
