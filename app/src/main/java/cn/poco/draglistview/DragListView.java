...
//        addView(mDragItem.getDragItemView());
    ...
    private DragItemRecyclerView createRecyclerView() {
        ...
        recyclerView.setLayoutParams(fl);
    ...
    public DragItem getCustomDragItem()
    {
        return mDragItem;
    }
    ...
    public void Clear()
    {
        if(mRecyclerView != null)
        {
            mRecyclerView.setDragItemCallback(null);
            mRecyclerView.setDragItemListener(null);
            mRecyclerView.setAdapter(null);
        }
        mDragListListener = null;
        mDragListCallback = null;
    }
    ...
    public void ScrollToCenter(int position)
    {
        if(mRecyclerView != null && mRecyclerView.getLayoutManager() != null)
        {
            ...
            if(layoutManager instanceof LinearLayoutManager)
            {
                ...
                if(child != null)
                {
                    int itemW = child.getWidth();
                    int WP = mRecyclerView.getWidth() - mRecyclerView.getPaddingLeft() - mRecyclerView.getPaddingRight();
                    int WC = itemW;
                    offsetX = (WP - WC) / 2;
                }
                ((LinearLayoutManager)layoutManager).scrollToPositionWithOffset(position, offsetX);
            }
        }
    }
    ...
    public class SpaceItemDe extends RecyclerView.ItemDecoration
    {
