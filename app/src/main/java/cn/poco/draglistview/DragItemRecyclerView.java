...
public class DragItemRecyclerView extends RecyclerView implements AutoScroller.AutoScrollListener {
    ...
    public void canFling(boolean canFling)
    {
        mFlingEnabled = canFling;
    }
    ...
    private View findChildView(float x, float y) {
        ...
        float curViewX = getLeft() - params.leftMargin;
        float curViewY = getTop() - params.topMargin;
    ...
    boolean startDrag(View itemView, long itemId, float x, float y) {
        ...
        mDragItemId = itemId;
        mDragItem.startDrag(this, itemView, x, y);
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                if (holder != null) {
                    ...
                    mDragItem.endDrag(DragItemRecyclerView.this, holder.itemView, new AnimatorListenerAdapter() {
                        @Override
