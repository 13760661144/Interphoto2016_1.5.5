...
public class CameraErrorTipsDialog extends AlertDialogV1 implements View.OnClickListener {
    ...
    private void initView() {
        ...
        title.setText(getContext().getString(R.string.cameraPermissionLimit));
        ...
        contentView.setText(getContext().getResources().getString(R.string.cameraNotCanOpenTips));
        ...
        tipText.setText(getContext().getResources().getString(R.string.openPermissionMethod));
